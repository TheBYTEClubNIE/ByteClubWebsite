...
const MsgBox = () => {
  ...
  return (
    <>
        ...
        <div className="msgBox hover:border hover:border-white hidden lg:block overflow-hidden static lg:absolute  text-gray-100 rounded-lg  shadow-lg p-6 sm:p-8 lg:p-10 sm:w-2/3 lg:w-1/2 right-14">
