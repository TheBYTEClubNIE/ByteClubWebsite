  ...
  return (
    <div className="flex items-center justify-center w-full h-fit z-50 absolute ">
      <nav className="navbar fixed w-max backdrop:blur-md bg-transparent mt-28 shadow-sm backdrop-blur-md">
        <button type="button" title="Events" className="btn">
          <a className="material-symbols-outlined" href="#events">
            
            <MdEmojiEvents />
          </a>
        </button>
        <button type="button" title="About" className="btn">
          <a className="material-symbols-outlined" href="#about">
            <MdInfo />
          </a>
        </button>
        <button type="button" className="active btn" title="Home">
          <a className="material-symbols-outlined" href="#home">
            <MdHome />
          </a>
        </button>
        <button type="button" title="Review" className="btn">
          <a className="material-symbols-outlined" href="#review">
            <MdRateReview />
          </a>
        </button>
        <button type="button" title="Feedback" className="btn">
          <a className="material-symbols-outlined" href="#write-review">
            <MdEmail />
          </a>
        </button>
      </nav>
