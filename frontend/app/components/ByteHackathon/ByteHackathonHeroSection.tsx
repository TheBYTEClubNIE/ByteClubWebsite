...
const ByteHackathonHeroSection = () => {
  ...
  const eventDate = new Date("2025-04-07T00:00:00").getTime();
    ...
    return (
        <div
            ref={heroRef}
            className="text-white text-center py-16 px-4 max-w-[800px] mx-auto relative"
        >
            <h1
                ref={titleRef}
            ...
            <p
                ref={taglineRef}
                className="text-md sm:text-xl md:text-2xl lg:text-3xl font-extrabold uppercase text-white shadow-glow animate-pulse"
            >
                CODE. <span className="text-yellow-400">COMPETE.</span>{" "}
                CELEBRATE.
            </p>
